...
module.exports = Object.freeze({
  ...
  datajudApiKey: secretFromEnv('DATAJUD_API_KEY'),
  googleFactCheckApiKey: secretFromEnv('GOOGLE_FACT_CHECK_API_KEY'),
  factCheckMaxAgeDays: integerFromEnv('FACT_CHECK_MAX_AGE_DAYS', 2920, 1),
  factCheckPageSize: integerFromEnv('FACT_CHECK_PAGE_SIZE', 10, 1),
  identityVaultRefreshOnStart: booleanFromEnv('IDENTITY_VAULT_REFRESH_ON_START', true),
